...
# Import target "Qt6::wasmdeployqt" for configuration "RelWithDebInfo"
set_property(TARGET Qt6::wasmdeployqt APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(Qt6::wasmdeployqt PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/wasmdeployqt.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::wasmdeployqt )
list(APPEND _cmake_import_check_files_for_Qt6::wasmdeployqt "${_IMPORT_PREFIX}/bin/wasmdeployqt.exe" )
