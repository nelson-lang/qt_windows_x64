...
# Import target "Qt6::lcheck" for configuration "RelWithDebInfo"
set_property(TARGET Qt6::lcheck APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(Qt6::lcheck PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/lcheck.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::lcheck )
list(APPEND _cmake_import_check_files_for_Qt6::lcheck "${_IMPORT_PREFIX}/bin/lcheck.exe" )
...
# Import target "Qt6::ltext2id" for configuration "RelWithDebInfo"
set_property(TARGET Qt6::ltext2id APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(Qt6::ltext2id PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/bin/ltext2id.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::ltext2id )
list(APPEND _cmake_import_check_files_for_Qt6::ltext2id "${_IMPORT_PREFIX}/bin/ltext2id.exe" )
