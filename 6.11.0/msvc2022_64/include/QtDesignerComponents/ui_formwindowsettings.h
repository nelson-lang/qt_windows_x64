...
public:
    ...
    QLabel *label_4;
    QLineEdit *idBasedTranslationLabelLineEdit;
    ...
    void setupUi(QDialog *FormWindowSettings)
    {
        ...
        formLayout = new QFormLayout(translationsGroupBox);
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::SpanningRole, idBasedTranslationsCheckBox);

        label_4 = new QLabel(translationsGroupBox);
        label_4->setObjectName("label_4");

        formLayout->setWidget(1, QFormLayout::ItemRole::LabelRole, label_4);

        idBasedTranslationLabelLineEdit = new QLineEdit(translationsGroupBox);
        idBasedTranslationLabelLineEdit->setObjectName("idBasedTranslationLabelLineEdit");

        formLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, idBasedTranslationLabelLineEdit);
        ...
        label_4->setBuddy(idBasedTranslationLabelLineEdit);
    ...
    void retranslateUi(QDialog *FormWindowSettings)
    {
        ...
        label_4->setText(QCoreApplication::translate("FormWindowSettings", "ID-based label:", nullptr));
#if QT_CONFIG(tooltip)
        idBasedTranslationLabelLineEdit->setToolTip(QCoreApplication::translate("FormWindowSettings", "Enter a label name to group id based translations of the form (optional)", nullptr));
